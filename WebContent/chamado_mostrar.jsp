...
<body>
	...
	<%
		...
		//Acompanhamento acompanhamento = (Acompanhamento) request
				//.getAttribute("Acompanhamento");
	%>

	<form class="form-horizontal" action="Servlet_Cadastrar_Acompanhamento"
		method="post">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<textarea id="descricao_problema" name="descricao_problema"
						...
						<%=chamado.getInfo_problema()%> </textarea>
				</div>
			</div>
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="acompanhamento_problema">Acompanhamento
					do problema</label>
				<div class="col-md-4">
					<textarea id="acompanhamento_problema" name="acompanhamento_problema" class="form-control" rows=""
						cols=""></textarea>
				</div>
			</div>
